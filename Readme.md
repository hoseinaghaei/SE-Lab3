...
<img src="tdd/image/coverage.png">

## پرسش چهارم
همانطور که در شکل مشخص است خطوطی از کلاس کتابخانه هنوز پوشش داده نشده است.

تنها کلاسی که خطوط قابل استفاده‌ آن کاملا پوشش نداده شده‌اند، کلاس کتابخانه است که ۲ تست دیگر به آن افزودیم.
<img src="tdd/image/coverage2.png">
درصد پوشش خطوط از ۶۶ به ۷۵ درصد رسید.
